...
var bufferReadTests = []struct {
	...
	{
		buffer{[]byte{'a', 0}, 0, 1, false, nil, false},
		5, 1, nil, []byte{'a'},
		buffer{[]byte{'a', 0}, 1, 1, false, nil, false},
	},
	{
		buffer{[]byte{'a', 0}, 0, 1, true, io.EOF, false},
		5, 1, io.EOF, []byte{'a'},
		buffer{[]byte{'a', 0}, 1, 1, true, io.EOF, false},
	},
	{
		buffer{[]byte{0, 'a'}, 1, 2, false, nil, false},
		5, 1, nil, []byte{'a'},
		buffer{[]byte{0, 'a'}, 2, 2, false, nil, false},
	},
	{
		buffer{[]byte{0, 'a'}, 1, 2, true, io.EOF, false},
		5, 1, io.EOF, []byte{'a'},
		buffer{[]byte{0, 'a'}, 2, 2, true, io.EOF, false},
	},
	{
		buffer{[]byte{}, 0, 0, false, nil, false},
		5, 0, errReadEmpty, []byte{},
		buffer{[]byte{}, 0, 0, false, nil, false},
	},
	{
		buffer{[]byte{}, 0, 0, true, io.EOF, false},
		5, 0, io.EOF, []byte{},
		buffer{[]byte{}, 0, 0, true, io.EOF, false},
	},
}
